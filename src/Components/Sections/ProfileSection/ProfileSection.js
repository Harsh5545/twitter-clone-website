    ...
    <>
      <div className={style.wrapper}>
        ...
        <img
          ...
          alt="Myimg.jpeg"
          src="https://www.shutterstock.com/shutterstock/videos/1023025072/thumb/1.jpg?ip=x480"
        />
        <div>
        ...
        <div key={Data.id} className={style.textcontaint}>
          ...
          <h4
            style={{ color: "silver" }}
          >{`${Data[getLocalStorageIndex].Email}`}</h4>
          <h5 style={{ marginTop: "1rem", fontSize: "1.2rem" }}>
          ...
          <div className={style.followerscont}>
            {" "}
            1000<span className={style.followers}> Followers</span> 10{" "}
